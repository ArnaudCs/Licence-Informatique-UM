...
Lemma combis : forall n m : nat, (plus n m) = (plus m n).
Proof.
 intros.
 elim n.
 elim m.
...
Lemma ex1_2bis : forall n : nat, (mult n 2) = (plus n n).
Proof.
 intros.
 elim n.
 simpl.
...
Lemma ex2_1bis : forall l : list A, forall e : A, (rev (app l (e :: nil))) = (e :: (rev l)).
Proof.
 intros.
 elim l.
 simpl.
...
Lemma ex2_2bis : forall l : list A, (rev (rev l)) = l.
Proof.
 intros.
 elim l.
 simpl.
