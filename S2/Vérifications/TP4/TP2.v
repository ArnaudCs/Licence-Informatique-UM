...
Lemma isos_ex1_2 : forall A B :Set, A * (B -> unit) = A.
Proof.
 simplifie.
Qed.

Lemma isos_ex2_2 : forall A B : Set, A * unit * B = B * (unit * A).
Proof.
 simplifie.
 rewrite (Com unit A).
 rewrite P_unit.
...
Lemma isos2_ex1 : (plus (s o) (s (s o))) = (s (s (s o))).
Proof.
 rewrite ax5.
 rewrite ax5.
 rewrite ax4.
...
Lemma isos2_ex2 : (plus (s (s o)) (s (s o))) = (s (s (s (s o)))).
Proof.
 rewrite ax5.
 rewrite ax5.
 rewrite ax4.
...
Lemma isos2_ex3 : (mult (s (s o)) (s (s o))) = (s (s (s (s o)))).
Proof.
 rewrite ax7.
 rewrite ax7.
 rewrite ax6.
